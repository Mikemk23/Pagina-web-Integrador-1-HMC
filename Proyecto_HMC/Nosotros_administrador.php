<?php
session_start();
$ID = $_SESSION['HMC_idAdmin_registro'];
...
<!---->            <img src="Imagenes/Logo.png" alt="Logo de la marca">
        ...
        <nav>
           <ul class="nav-links">
                <li><a href="ppl_administrador.php">Inicio</a></li>
                <li><a href="Proyectos_administrador.php">Proyectos</a></li>
                <li><a href="Nosotros_administrador.php">Nosotros</a></li>
                <li><a href="Soporte_administrador.php">Soporte</a></li>
           </ul>            
        </nav>
        <a class="btn" href="administrador.php"><button><?php echo $ID; ?></button></a>
...
<!---->                <a href="ppl_administrador.php">Inicio</a>
<!---->                <a href="Proyectos_administrador.php">Proyectos</a>
<!---->                <a href="Nosotros_administrador.php">Nosotros</a>
                       <a href="Soporte_administrador.php">Soporte</a>
<!---->                <a href="administrador.php"><?php echo $ID; ?></a>
<!---->            </div>
<!---->        </div>
    </header>
          ...
          <div class="info-contact">
            ...
            <div class="call">
              <h6>
                ...
                <img src="Imagenes/telephone.png" >
                <span>
                  ( 7227536699 )
                </span>
            </div>
