...
$PASSWORD = $_SESSION['HMC_passwordAdmin_registro'];
...
max-width: 400px;';
            ...
            {                                
                ...
                $sql_borrar_sesion_finalizada = "DELETE FROM HMC_sesionAdmin_finalizada WHERE HMC_idAdmin_sesion = '$ID'";
                $sql_borrar_sesion_iniciada = "DELETE FROM HMC_sesionAdmin_iniciada WHERE HMC_idAdmin_sesion = '$ID'";
                $sql_borrar_registro = "DELETE FROM HMC_registroAdmin WHERE HMC_idAdmin_registro = '$ID'";                                                           
